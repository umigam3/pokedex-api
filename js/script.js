$(document).ready(function(){
  ...
  function createMainTable() {
    ...
    let searchContent = $(".main-content__table-content")[0]
    if (searchContent) {
    ...
    $(".main-content")[0].appendChild(content);
  ...
  function addElement(pokemon) {
    ...
    $(".table-content__main-table")[0].appendChild(tableRow);
  ...
  function sortTable(index, mode) {
    ...
    table = $(".table-content__main-table")[0];
    switching = true;
  ...
  $(".kanto, .johto, .hoenn, .sinnoh, .teselia, .kalos, .alola, .all").on( 'click', function() {
    let url = "";
    let clickedClass = this.className;
    if (clickedClass == 'kanto') url = "https://pokeapi.co/api/v2/pokemon?limit=151&offset=0";
    else if (clickedClass == 'johto') url = "https://pokeapi.co/api/v2/pokemon?limit=100&offset=151";
    else if (clickedClass == 'hoenn') url = "https://pokeapi.co/api/v2/pokemon?limit=135&offset=251";
    else if (clickedClass == 'sinnoh') url = "https://pokeapi.co/api/v2/pokemon?limit=107&offset=386";
    else if (clickedClass == 'teselia') url = "https://pokeapi.co/api/v2/pokemon?limit=155&offset=494";
    else if (clickedClass == 'kalos') url = "https://pokeapi.co/api/v2/pokemon?limit=72&offset=649";
